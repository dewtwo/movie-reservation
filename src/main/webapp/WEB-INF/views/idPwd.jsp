		...
		<form name="form1" action="/searchId.do" method="post"
			...
			<center>
				<table>
					...
					<tr>
						<td class="tdwidth">휴대폰</td>
						<td>
						<input type="text" class="form-control" id="email"
						name="phone" placeholder="휴대폰 번호를 입력하세요.">
						</td>
					</tr>
					<tr>
						<td class="tdwidth"></td>
						<td align="right">
						<button type="submit" class="btn btn-default" id="ok">확인</button>
						</td>
					</tr>
				</table>
			...
			<center>
				<table>
					...
					<tr>
						<td class="tdwidth">휴대폰</td>
						<td><input type="text" class="form-control" id="email"
						name="phone" placeholder="휴대폰번호를 입력하세요."></td>
					</tr>
					<tr>
						<td class="tdwidth"></td>
						<td align="right">
